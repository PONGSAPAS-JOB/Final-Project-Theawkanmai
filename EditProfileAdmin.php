...
if (isset($_POST['update'])) {
    ...
    $sql = $updatedata->updateProfileAdmin(
        $filename1,
        $username,
        $email,
        $phone,
...
<body>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            // Show preview for img_admin or default image
            const img_adminValue = "<?php echo $img_admin ? $img_admin : ''; ?>";
            showPreview(img_adminValue, 'imgPreview1', 'uploadfile1');
        });
    </script>
    <div class="addplace ">
