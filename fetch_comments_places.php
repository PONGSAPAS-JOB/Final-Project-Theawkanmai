...
if (isset($_POST['id_places'])) {
    ...
    // Fetch total views
    $total_views = $fetchdata->getTotalViewsplaces($id_places);

    // Fetch average rating
    $average_rating = $fetchdata->getAverageRatingplaces($id_places);
    ...
    if ($result) {
        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            echo "<p> : " . nl2br(htmlspecialchars($row['detail_comment'])) . "</p>"; // Convert newlines to <br> for better formatting
